...
for simu in ["simu30", "simu10", "simu03"]:
    ...
    runm2a(simu_folder, uninfpi50m2a_options, "uninfpi50m2a", machine="occigen", queue="none", core = 24, njobs_per_batch = 24, time = 6, mem=16, path2batch = simu_folder + "/singlegene/", path2run = path2bayescode_occigen)
    runm2a(simu_folder, uninfpi10m2a_options, "uninfpi10m2a", machine="occigen", queue="none", core = 24, njobs_per_batch = 24, time = 6, mem=16, path2batch = simu_folder + "/singlegene/", path2run = path2bayescode_occigen)
    runm2a(simu_folder, uninfpi02m2a_options, "uninfpi02m2a", machine="occigen", queue="none", core = 24, njobs_per_batch = 24, time = 6, mem=16, path2batch = simu_folder + "/singlegene/", path2run = path2bayescode_occigen)

    runm2a(simu_folder, subjpi50m2a_options, "subjpi50m2a", machine="occigen", queue="none", core = 24, njobs_per_batch = 24, time = 6, mem=16, path2batch = simu_folder + "/singlegene/", path2run = path2bayescode_occigen)
    runm2a(simu_folder, subjpi10m2a_options, "subjpi10m2a", machine="occigen", queue="none", core = 24, njobs_per_batch = 24, time = 6, mem=16, path2batch = simu_folder + "/singlegene/", path2run = path2bayescode_occigen)
    runm2a(simu_folder, subjpi02m2a_options, "subjpi02m2a", machine="occigen", queue="none", core = 24, njobs_per_batch = 24, time = 6, mem=16, path2batch = simu_folder + "/singlegene/", path2run = path2bayescode_occigen)

    runm2a(simu_folder, infm2a_options, "infm2a", machine="occigen", queue="none", core = 24, njobs_per_batch = 24, time = 6, mem=16, path2batch = simu_folder + "/singlegene/", path2run = path2bayescode_occigen)
